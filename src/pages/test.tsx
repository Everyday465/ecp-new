...
const useResetFormOnCloseModal = ({ form, open }: { form: FormInstance; open: boolean }) => {
    const prevOpenRef = useRef<boolean | null>(null); // Explicitly set the initial type to include null.
    
    useEffect(() => {
      prevOpenRef.current = open; // This assignment is safe as we defined the ref as mutable.
    }, [open]);
